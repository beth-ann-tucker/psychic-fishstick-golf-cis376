//contains all games that have been shared so far
const games = [
  {
...
// iterate over the JSON array to display the games in cards
$.each(games, function (index, item) {

var card = `<div class="col-sm"> <div class='card'> \
  <h2 class='card-title'> ${ item.title } </h2> \
   <div class='card-body'> Create by: ${ item.author } </div>\
...
//assigns what row this card will be in
